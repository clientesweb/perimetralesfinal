...
const typeOptions = [
  { id: "8flores", name: "8 Flores x 1 metro" },
  { id: "8dientes", name: "8 Dientes x 1 metro" },
]
      ...
      <main className="flex-1">
        ...
        <div className="container py-8">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <div className="mb-6">
                <h1 className="text-3xl font-anton tracking-tight mb-2">PINCHES / VARILLAS DE SEGURIDAD</h1>
                ...
                <p className="text-gray-700 mb-6">
                  Las varillas de seguridad son un sistema anti-escalamiento eficaz para muros y cercos perimetrales.
                  Disponibles en configuraciones de 8 flores y 8 dientes por metro lineal. Fabricadas en materiales de
                  alta resistencia para máxima durabilidad y efectividad.
                </p>

                {/* Type Selection */}
                <div className="mb-6">
                  <h3 className="text-sm font-medium mb-3">Tipo de Varilla</h3>
                  <div className="grid grid-cols-1 gap-3">
                    {typeOptions.map((type) => (
                      <button
                        key={type.id}
                        className={`border rounded py-3 px-4 text-sm font-medium transition-colors ${
          ...
          <Tabs defaultValue="descripcion">
            ...
            <TabsContent value="descripcion" className="pt-6">
              <div className="prose max-w-none">
                <h3>Pinches / Varillas de Seguridad - Protección Anti-escalamiento Efectiva</h3>
                <p>
                  Las varillas de seguridad son un sistema disuasorio diseñado para prevenir el escalamiento de muros,
                  cercos y otras superficies perimetrales. Disponibles en dos configuraciones especializadas para
                  diferentes niveles de protección.
                </p>
                <h4>Características principales:</h4>
                <ul>
                  <li>Disponibles en configuración de 8 flores por metro</li>
                  <li>Disponibles en configuración de 8 dientes por metro</li>
                  <li>Longitud estándar de 1 metro por varilla</li>
                  <li>Fabricadas en acero galvanizado de alta resistencia</li>
                  <li>Resistentes a la intemperie y a temperaturas extremas</li>
                  <li>Fácil instalación mediante sistemas de montaje</li>
                  <li>Diseño disuasorio efectivo que cumple con normativas de seguridad</li>
                </ul>
              </div>
            </TabsContent>
              ...
              <div className="prose max-w-none">
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    ...
                    <tr className="border-b">
                      <td className="py-3 font-medium">Configuraciones</td>
                      <td className="py-3">8 Flores x 1 metro, 8 Dientes x 1 metro</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 font-medium">Longitud estándar</td>
                      <td className="py-3">1 metro por varilla</td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3">10-15 años en exteriores</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <TabsContent value="instalacion" className="pt-6">
              <div className="prose max-w-none">
                ...
                <p>
                  La instalación de las varillas de seguridad es un proceso sencillo que puede realizar usted mismo.
                  Siga estos pasos para lograr una instalación efectiva:
                </p>
                <h4>Materiales necesarios:</h4>
                <ul>
                  <li>Varillas de seguridad</li>
                ...
                <ol>
                  <li>
                    <strong>Planificación:</strong> Determine las áreas donde instalará las varillas de seguridad. Mida
                    la longitud total necesaria.
                  </li>
                  <li>
                    <strong>Preparación de la superficie:</strong> Limpie la superficie donde se instalarán las
                    varillas, eliminando polvo, suciedad o grasa. La superficie debe estar seca.
                  </li>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        las varillas y presione firmemente sobre la superficie.
                      </li>
                      <li>
                  ...
                  <li>
                    <strong>Colocación:</strong> Instale las varillas en línea recta, asegurándose de que queden
                    firmemente fijadas. Para esquinas o curvas, puede cortar las tiras con una sierra para ajustarlas a
                    la forma necesaria.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Verificación:</strong> Una vez instaladas todas las varillas, verifique que estén
                    correctamente fijadas y estables.
                  </li>
                </ol>
                <h4>Recomendaciones adicionales:</h4>
                <ul>
                  <li>
                    Instale las varillas en la parte superior de muros, rejas o superficies a proteger, orientando las
                    puntas hacia arriba y hacia afuera.
                  </li>
                  <li>Para mayor efectividad, instale las varillas en dos o tres filas escalonadas.</li>
                  <li>
                    En zonas con alta exposición al sol, asegúrese de que las varillas estén bien fijadas, ya que el
                    calor puede afectar algunos adhesivos.
                  </li>
                  <li>
                    Considere colocar señalización que advierta sobre la presencia de las varillas para evitar
                    accidentes.
                  </li>
                </ul>
                <p>
